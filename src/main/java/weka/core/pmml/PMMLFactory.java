...
*/
  ...
  */
   ...
   * @throws Exception if there is a problem while reading from the stream
   */
  public static PMMLModel getPMMLModel(InputStream stream) throws Exception { // my changes Logger log
  ...
  public static void main(String[] args) {
    try {
      ...
      //PMMLModel model = getPMMLModel(pmmlFile, null);my changes
