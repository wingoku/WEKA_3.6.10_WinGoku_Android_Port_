...
// A little doubt about what initStemmer() does. So not sure the consequences of commenting out intitStemer()
...
public class SnowballStemmer 
  ...
  /*private static void initStemmers() { my changes
    Vector        classnames;
    int           i;
