...
public abstract class PMMLClassifier extends Classifier
  ...
  /** Logger */
  //protected Logger m_log = null; my changes
  ...
  /*public void setLog(Logger log) { my changes
    m_log = log;
  }
  */
  /**
  ...
  /*public Logger getLog() {my changes
    return m_log;
  }
*/
  /**
  ...
  public void mapToMiningSchema(Instances dataSet) throws Exception {
    if (m_fieldsMap == null) {
      ...
      m_fieldsMap = new MappingInfo(dataSet, m_miningSchema); // my changes to this: m_fieldsMap = new MappingInfo(dataSet, m_miningSchema, m_log);
      m_initialized = true;
    }
  }
